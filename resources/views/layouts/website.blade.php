            ...
            $.ajax({
                ...
                success:function(res) {
                    ...
                    $.each(res, function(key, value) {
                        // console.log(value)
                        if(value.attributes.offer_price == null || value.attributes.offer_price == "") {
                            ...
                            data = data + '<div class="product product-cart"><div class="product-detail"><a href="" class="product-name">'+value.name+'</a><div class="price-box"><span class="product-quantity">'+value.quantity+'</span><span class="product-price">'+value.attributes.offer_price+'TK</span></div></div><figure class="product-media"><a href=""><img src="'+ location.origin +'/uploads/product/thumbnail/'+value.attributes.image+'" alt="'+value.attributes.slug+'" height="84" width="94" /></a></figure><button class="btn btn-link btn-close" onclick="deleteCard('+value.id+')" aria-label="button"><i class="fas fa-times"></i></button></div>'
                        }
                    })
