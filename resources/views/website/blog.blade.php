                ...
                <div class="main-content">
                    <div class="row cols-sm-2">
                        <article class="post post-grid-type overlay-zoom mb-6 fashion">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/1.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                        ...
                        <article class="post post-grid-type overlay-zoom mb-6 others technology">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/2.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                            <div class="post-details">
                        ...
                        <article class="post post-grid-type overlay-zoom mb-6 clothes">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/3.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                            <div class="post-details">
                        ...
                        <article class="post post-grid-type overlay-zoom mb-6 lifestyle">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/4.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                            <div class="post-details">
                        ...
                        <article class="post post-grid-type overlay-zoom mb-6 entertainment lifestyle shoes others">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/5.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                            <div class="post-details">
                        ...
                        <article class="post post-grid-type overlay-zoom mb-6 fashion lifestyle">
                            <figure class="post-media br-sm">
                                <a href="{{route('blog.details')}}">
                                    <img src="website/images/blog/2cols/6.jpg" width="600"
                                        height="420" alt="blog">
                                </a>
                            </figure>
                            <div class="post-details">
