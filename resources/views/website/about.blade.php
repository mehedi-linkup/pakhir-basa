    ...
    <div class="page-content">
        <div class="container">
            <section class="introduce mb-10 pb-10">
                ...
                <figure class="br-lg">
                    <img src="website/images/pages/about_us/1.jpg" alt="Banner" 
            ...
            <section class="customer-service mb-7">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="website/images/pages/about_us/2.jpg" alt="Banner"
        ...
        <section class="boost-section pt-10 pb-10">
            <div class="container mt-10 mb-9">
                <div class="row align-items-center mb-10">
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img src="website/images/pages/about_us/3.jpg" alt="Banner"
