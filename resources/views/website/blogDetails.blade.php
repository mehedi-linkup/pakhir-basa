                ...
                <div class="main-content post-single-content">
                    <div class="post post-grid post-single">
                        <figure class="post-media br-sm">
                            <img src="website/images/blog/single/1.jpg" alt="Blog" width="930" height="500" />
                        </figure>
                    ...
                    <div class="post-author-detail">
                        <figure class="author-media mr-4">
                            <img src="website/images/blog/single/1.png" alt="Author" width="105" height="105" />
                        </figure>
                        ...
                        <div class="post-slider swiper-container swiper-theme nav-top pb-2" data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1">
                                <div class="swiper-slide post post-grid">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="website/images/blog/single/2.jpg" alt="Post" width="296"
                                ...
                                <div class="swiper-slide post post-grid">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="website/images/blog/single/3.jpg" alt="Post" width="296"
                                ...
                                <div class="swiper-slide post post-grid">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="website/images/blog/single/4.jpg" alt="Post" width="296"
                                ...
                                <div class="swiper-slide post post-grid">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="website/images/blog/single/5.jpg" alt="Post" width="296"
                    ...
                    <ul class="comments list-style-none pl-0">
                        <li class="comment">
                            <div class="comment-body">
                                <figure class="comment-avatar">
                                    <img src="website/images/blog/single/1.png" alt="Avatar" width="90" height="90" />
                                </figure>
                        ...
                        <li class="comment">
                            <div class="comment-body">
                                <figure class="comment-avatar">
                                    <img src="website/images/blog/single/2.png" alt="Avatar" width="90" height="90" />
                                </figure>
                                <div class="comment-content">
                                    <h4 class="comment-author font-weight-bold">
                                        <a href="#">Semi Colon</a>
                                            ...
                                            <div class="swiper-wrapper row cols-1">
                                                <div class="swiper-slide widget-col">
                                                    <div class="post-widget mb-4">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/1.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                    ...
                                                    <div class="post-widget mb-4">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/2.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                    ...
                                                    <div class="post-widget mb-2">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/3.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                                <a href="#" class="post-date">March 1, 2021</a>
                                                ...
                                                <div class="swiper-slide widget-col">
                                                    <div class="post-widget mb-4">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/4.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                                <a href="#" class="post-date">March 1, 2021</a>
                                                    ...
                                                    <div class="post-widget mb-4">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/5.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                                <a href="#" class="post-date">March 5, 2021</a>
                                                    ...
                                                    <div class="post-widget mb-2">
                                                        <figure class="post-media br-sm">
                                                            <img src="website/images/blog/sidebar/6.jpg" alt="150" height="150" />
                                                        </figure>
                                                        <div class="post-details">
                                                            <div class="post-meta">
                                                                <a href="#" class="post-date">March 1, 2021</a>
