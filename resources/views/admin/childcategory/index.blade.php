           ...
           <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <div class="table-head"><i class="fas fa-cogs me-1"></i>Child Category Form</div>
                    </div>
                        <div class="card-body table-card-body p-3">
                          @if (Session('duplicate'))
                              <div class="alert alert-warning">
                                  <span>This Child Category Already taken</span>
                              </div>
                          @endif
                        <form action="{{ route('childcategory.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <select name="subcategory_id" id="subcategory_id" class="form-control form-control-sm @error('subcategory_id') is-invalid @enderror">
             ...
             <div class="col-6">
               <div class="card"> 
                <div class="card-header">
                    <div class="table-head"><i class="fas fa-table me-1"></i>Child Category List <a href="" class="float-right"><i class="fas fa-print"></i></a></div>
                </div>
                <div class="card-body table-card-body p-3">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('childcategory.edit', $item->id) }}" class="btn btn-edit"><i class="fas fa-pencil-alt"></i></a>
                                    <button type="submit" class="btn btn-delete" onclick="deleteUser({{ $item->id }})"><i class="far fa-trash-alt"></i></button>
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('childcategory.destroy', $item) }}"
